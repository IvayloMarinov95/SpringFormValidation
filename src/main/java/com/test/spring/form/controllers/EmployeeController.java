package com.test.spring.form.controllers;
...
import com.test.spring.form.model.Employee;
...
public class EmployeeController {
	...
	public Employee createEmployeeModel() {
		//ModelAttribute value should be same as used in the empSave.js
		return new Employee();
	}
	...
	public String saveEmployeeAction(@ModelAttribute("employee") @Validated Employee employee, BindingResult bindingResult, Model model) {
		if(bindingResult.hasErrors()) {
			logger.info("Returning empSave.js page");
			return "empSave";
		}
